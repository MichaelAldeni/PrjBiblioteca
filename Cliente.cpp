...
Cliente::Cliente(string n, string c, string cod_fisc, string us_name, string pass, int num)
{
	nome = n;
	cognome = c;
...
bool is_on(string str, vector<Cliente>& vect)
{
...
void elimina_Cliente(Cliente x, vector <Cliente>& vect)
{
	vector<Cliente>::iterator it;
	for (it = vect.begin(); it != vect.end(); it++) {
...
void registrazione(vector <Cliente>& vect)
{
	bool ceck = true;
...
ostream& operator<<(ostream &os, Cliente x)
{
...
void stampa_vettore(vector <Cliente>& vect)
{
	vector<Cliente>::iterator it;
...
void stampa_Cliente(string user, vector <Cliente>& vect)
{
	vector<Cliente>::iterator it;
